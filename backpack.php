                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<div class="pull-right">
								...
								<?php
								$query_backpack = mysqli_query($conn,"select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ")or die(mysqli_connect_error());
								...
								?>
									...
									<?php include('modal_backpack_delete.php'); ?>
										...
										<tbody>
                              		<?php
										$query = mysqli_query($conn,"select * FROM student_backpack where student_id = '$session_id'  order by fdatein DESC ")or die(mysqli_connect_error());
