						...
						<div class="span9" id="content">
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysqli_query($conn,"select * from subject where subject_id = '$get_id'")or die(mysqli_connect_error());
									...
									?>
										...
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$user_username','Edit Subject $subject_code')")or die(mysqli_connect_error());
