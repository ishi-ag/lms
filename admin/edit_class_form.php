   <div class="row-fluid">
       <a href="class.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Class</a>
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($conn,"select * from class where class_id = '$get_id'")or die(mysqli_connect_error());
...
mysqli_query($conn,"update class set class_name = '$class_name' where class_id = '$get_id' ")or die(mysqli_connect_error());
?>
