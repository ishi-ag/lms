       ...
       <a href="teachers.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Teacher</a>
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
									<?php
									$query = mysqli_query($conn,"select * from teacher where teacher_id = '$get_id' ")or die(mysqli_connect_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($conn,"select * from teacher join  department")or die(mysqli_connect_error());
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								$query = mysqli_query($conn,"select * from teacher where firstname = '$firstname' and lastname = '$lastname' ")or die(mysqli_connect_error());
								...
								mysqli_query($conn,"update teacher set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where teacher_id = '$get_id' ")or die(mysqli_connect_error());	
