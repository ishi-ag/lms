                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
									...
									<?php 
								$query_reg_teacher = mysqli_query($conn,"select * from teacher where teacher_status = 'Registered' ")or die(mysqli_connect_error());
								...
								<?php 
								$query_teacher = mysqli_query($conn,"select * from teacher")or die(mysqli_connect_error());
								...
								<?php 
								$query_student = mysqli_query($conn,"select * from student where status='Registered'")or die(mysqli_connect_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Registered Students</strong>
										...
										<?php 
								$query_student = mysqli_query($conn,"select * from student")or die(mysqli_connect_error());
								$count_student = mysqli_num_rows($query_student);
								?>
                                ...
                                <div class="span3">
									...
									<?php 
								$query_class = mysqli_query($conn,"select * from class")or die(mysqli_connect_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Class</strong>
										...
										<?php 
								$query_file = mysqli_query($conn,"select * from files")or die(mysqli_connect_error());
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Downloadable File</strong>
										...
										<?php 
								$query_subject = mysqli_query($conn,"select * from subject")or die(mysqli_connect_error());
