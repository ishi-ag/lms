                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 	$query = mysqli_query($conn,"select * FROM files where class_id = '$get_id' order by fdatein DESC ")or die(mysqli_connect_error());
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									$query = mysqli_query($conn,"select * FROM files where class_id = '$get_id' order by fdatein DESC ")or die(mysqli_connect_error());
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
